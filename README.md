...
本模板参考了16年电信学院及计算机学院毕业同学上传的两个修改版本。目录格式参考了本校诸多之前毕业同学的word格式以及CCF优博论文格式，本校参考文献格式与IEEE格式要求不同，因此设置使用了上海财经大学一位同学的模板，并在基础上有痕量修改。因此已较为完善。版本命名为1.2ε 有开发LyX模板的同学可进行格式参考。
